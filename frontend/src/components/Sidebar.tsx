...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, setIsOpen }) => {
  ...
  const buyerNavigation: NavigationItem[] = [
    ...
    },
    {
      name: 'Matches',
      href: '/buyer/matches',
      current: location.pathname.includes('/buyer/matches'),
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      name: 'My Offers',
      href: '/buyer/offers',
      current: location.pathname.includes('/buyer/offers'),
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" />
        </svg>
    ...
    },
    {
      ...
      current: location.pathname.includes('/buyer/watchlist'),
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const secondaryNavigation = [
    {
      name: 'Settings',
      href: `/${role}/settings`,
      current: location.pathname.includes(`/${role}/settings`),
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      name: 'Help & Support',
      href: `/${role}/support`,
      current: location.pathname.includes(`/${role}/support`),
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
